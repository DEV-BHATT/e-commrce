<%@ Page Title="" Language="C#" MasterPageFile="~/UserDashBoard.Master" AutoEventWireup="true" CodeBehind="Updateprofile.aspx.cs" Inherits="DreamDrive.Updateprofile" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label1" runat="server" ForeColor="Black" 
        Text="Sign Up for DreamDrive" Font-Bold="True" Font-Italic="True" 
        Font-Size="X-Large" BackColor="#FFCCFF"></asp:Label>
    <br />
    <br />
    <br />
    <asp:Label ID="Label2" runat="server" ForeColor="Lime" 
        Text="Please Complete Your Detalis"></asp:Label>
    <br />
    <br />
    ...
    <asp:TextBox ID="TextBox1" runat="server" Width="572px" BorderColor="#660066" 
        BorderStyle="Outset"  class="ne" Height="26px" ReadOnly="True" 
