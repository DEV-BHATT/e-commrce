...
{
    public partial class Car_store : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string scom = "Insert into product values(@productId,@productName,@productcat,@productqty,@price,@productImg)";
        ...
        {
            Response.Redirect ("productview.apsx");
        }
    }
}    
