<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="DreamDrive.ContactUs" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
    <br />
    <asp:Label ID="Label1" runat="server" ForeColor="#CC9900" Text="Contact Us"></asp:Label>
</p>
<p>
...
&nbsp;</p>
<p>
    <asp:Label ID="Label11" runat="server" ForeColor="#0000CC" Text="Contact Id"></asp:Label>
        &nbsp;&nbsp;&nbsp;
...
<p>
&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label10" runat="server" ForeColor="#0000CC" Text="Reason"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" ForeColor="#333300" 
            onclick="Button1_Click" Text="Contact Us" Width="504px" />
</p>
<p>
</p>
<p>
