...
{
    public partial class AddAcc : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string scom = "Insert into accessories values(@productId,@productName,@productcat,@productqty,@price,@productImg)";
